...
class RunnerGui(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(server_row, text="Sim Client API Server:", width=21, anchor="w").grid(row=0, column=1, sticky="w")
        ttk.Label(server_row, textvariable=self.server_status, width=22, anchor="w").grid(row=0, column=2, padx=(6, 0), sticky="w")
        ...
        ttk.Label(api_row, text="Website API:", width=21, anchor="w").grid(row=0, column=1, sticky="w")
        ttk.Label(api_row, textvariable=self.api_status, width=22, anchor="w").grid(row=0, column=2, padx=(6, 0), sticky="w")
        ...
        ttk.Label(simc_row, text="SimC Auto-Update:", width=21, anchor="w").grid(row=0, column=1, sticky="w")
        ttk.Label(simc_row, textvariable=self.simc_status, width=22, anchor="w").grid(row=0, column=2, padx=(6, 0), sticky="w")
        self._simc_check_btn = ttk.Button(simc_row, text="Check Now", command=self._start_simc_auto_update_check, width=10)
        self._simc_check_btn.grid(row=0, column=3, padx=(10, 0), sticky="w")
